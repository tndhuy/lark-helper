...
export function registerCalendarTools(server) {
    // Agenda
    server.tool("calendar_agenda", "List agenda/events for today or a specific date", {
    ...
    // Free/Busy
    server.tool("calendar_freebusy", "Query user free/busy status", {
    ...
    // Suggest time
    server.tool("calendar_suggestion", "Get meeting time suggestions", {
