...
export function registerWikiTools(server) {
    server.tool("wiki_list_spaces", "Get a list of Wiki spaces the user or bot has access to.", {
    ...
    server.tool("wiki_get_node", "Get information about a specific node in a Wiki space by node_id.", {
    ...
    server.tool("wiki_list_nodes", "List child nodes within a Wiki space or under a specific parent node.", {
