...
export function registerKBTools(server: McpServer) {
  ...
  server.tool(
    "lark_execute",
    "Run a Node.js script to process large Lark data locally in a sandbox.",
    {
  ...
  server.tool(
    "lark_index_wiki",
    "Index a Lark Wiki space for fast local searching.",
    {
  ...
  server.tool(
    "lark_search",
    "Search across indexed Lark content using full-text search.",
    {
